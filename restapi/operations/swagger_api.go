...
func NewSwaggerAPI(spec *loads.Document) *SwaggerAPI {
	return &SwaggerAPI{
		...
		TestPostReaderHandler: TestPostReaderHandlerFunc(func(params TestPostReaderParams) middleware.Responder {
			return middleware.NotImplemented("operation TestPostReader has not yet been implemented")
		}),
	}
}
...
type SwaggerAPI struct {
	...
	// TestPostReaderHandler sets the operation handler for the test post reader operation
	TestPostReaderHandler TestPostReaderHandler
...
func (o *SwaggerAPI) Validate() error {
	...
	if o.TestPostReaderHandler == nil {
		unregistered = append(unregistered, "TestPostReaderHandler")
	}
...
func (o *SwaggerAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/test"] = NewTestPostReader(o.context, o.TestPostReaderHandler)
}
